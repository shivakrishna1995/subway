...
export default z.object({
    ...
    type: z.enum(["6-inch", "Footlong", "Wrap", "Salad Box", "Jacket Potato"]),
    ...
    side: z.enum(["Double Chocolate Cookie (Ve)", "Chocolate Chunk Cookie", "Rainbow Chocolate Chip Cookie", "White Chip Macadamia Nut Cookie",
    ...
    drink: z.enum(['Coca-Cola Original 500ml', 'Coca-Cola Zero 500ml', 'Coca-Cola Zero Cherry 500ml', 'Coke Zero 1.25L', 'Costa Caramel Latte 250ml',
